				...
				<div class="nav-collapse collapse navbar-inverse-collapse">
					...
					<ul class="nav pull-right">
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							data-toggle="dropdown">Drops <b class="caret"></b></a>
				...
				<div class="span3">
					<div class="sidebar">
						...
						<ul class="widget widget-menu unstyled">
							...
							<li><a href="#"> <i class="menu-icon icon-bullhorn"></i>
									Calendar
							</a></li>
							<li><a href="#"> <i class="menu-icon icon-inbox"></i>
									Statistics
							</a></li>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<form:input path="startDate" id="startDate" 
												placeholder="When will the project Start?" class="span8"
												required="required" />
										</div>
									</div>
