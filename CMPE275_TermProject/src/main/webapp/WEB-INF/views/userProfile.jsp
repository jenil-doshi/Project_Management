...
<head>
    ...
    <link href="<c:url value="/assets/images/icons/css/font-awesome.css"/>" rel="stylesheet" />
     <!-- CUSTOM STYLE CSS -->
    <style type="text/css">
               .btn-social {
            color: white;
...
<body>
    <div class="navbar navbar-default navbar-static-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">User Profile Page</a>
            </div>
    ...
    <div class="container">
        <section style="padding-bottom: 50px; padding-top: 50px;">
            <div class="row">
                <div class="col-md-4">
                    <img src="<c:url value="/assets/bootstrap/img/250x250.png"/>" class="img-rounded img-responsive" />
                    <br />
                    <br />
    ...
    <!-- CORE JQUERY FILE -->
    <script src="<c:url value="/assets/bootstrap/js/jquery-1.11.1.js"/>"></script>
